  ...
  const handleCreateCourse = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const courseData = {
        ...
        slug: slug,
        teacher_id: user.id,
        is_approved: true, // Admin courses are auto-approved
        is_published: false,
      };
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-blue-700 mt-1">
                Los cursos creados por administradores se aprueban automáticamente y pueden publicarse inmediatamente.
              </p>
            </div>
          </div>
        </div>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-sky-50 border border-sky-200 rounded-lg p-5">
                  ...
                  <ul className="text-sm text-sky-800 space-y-1">
                    ...
                    <li>✓ Publicar el curso cuando esté listo</li>
                  </ul>
                </div>
              </div>
            </div>
